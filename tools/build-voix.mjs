...
const PHRASE_ESSAI = 'Regarde bien : la Lune n’a pas vraiment changé de forme ! '
  + 'C’est nous qui la voyons d’un côté différent chaque nuit… pendant qu’elle tourne autour de la Terre !';
